...
import './about.css'
import mobileAndWeb from 'src/images/mobile&web.png'
...
//const navigate= useNavigate()
  ...
  return (
    ...
    <img  className='CTAboximg1' src={mobileAndWeb} alt="search image"/>
      ...
      <h1 style={{fontWeight:"700",color:"#40255F",fontSize:"2.8rem"}}> Every Touchpoint is Personal{/*<span className="text-accent">  get the Job! </span>*/}</h1>
