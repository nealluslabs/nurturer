...
const FusePageBadPage = forwardRef((props, ref) => {
  // console.info("render::FusePageBadPage");
...
FusePageBadPage.defaultProps = {};

export default memo(FusePageBadPage);
